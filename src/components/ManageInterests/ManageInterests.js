            ...
            if(int.active){
                ...
                return <div className="pa3 pa5-ns" key={int.id}>
                    ...
                    <dl className="f6 lh-title mv2">
                        ...
                        {int.foundAdverts.map(advert => <dd className="dib ml0 gray"><a href={advert.url}>{advert.url}</a>,</dd>)}

                    </dl>
                    <button className="f6 link dim br1 ph3 pv2 mb2 dib white bg-black" onClick={() => {editInterest(int)}}>Edit</button>
